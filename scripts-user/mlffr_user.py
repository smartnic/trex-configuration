...
if __name__ == "__main__":
    ...
    while found: 
        ...
        # load xdp program 
        print("Loading...")
        os.system(f"ssh -p 22 {node0} \"sh -c 'python3 -u /usr/local/trex-configuration/scripts/load_xdp_user.py -b {args.benchmark} -v {args.version.lower()} -m {round(rate, 3)} -r {args.run} -d {args.directory} &'\"")
